...
extern "C"
{
	...
	LSAPI int ParseCoordinate(char strVal[], int defaultVal, int maxVal);
	...
	LSAPI BOOL WINAPI LSGetLitestepPath(LPSTR, UINT);
	LSAPI BOOL WINAPI LSGetImagePath(LPSTR, UINT);
